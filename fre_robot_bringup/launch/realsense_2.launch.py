...
def launch_setup(context, params, param_name_suffix=''):
    ...
    # Override params
    params['serial_no'] = '801312070183'
    params['camera_name'] = 'realsense_2' # camrea base link is camera_name + '_link'
    ...
    static_tf_node = Node(
        ...
        arguments=['0.19', '0', '0.15', '0', '0', '0',  # x y z roll pitch yaw
                   'base_link', 'realsense_2_link']     # parent frame, child frame
    )

    return [realsense_node, static_tf_node]
